...
lin
   ...
   break_V2      = mkV2 (mkV "quebrar") ;
   buy_V2        = mkV2 (mkV "comprar") ;
   close_V2      = mkV2 (mkV "fechar") ;
   count_V2      = mkV2 (mkV "contar") ;
   cut_V2        = mkV2 (mkV "cortar") ;
   do_V2         = mkV2 (mkV (fazer_Besch "fazer")) ;
   drink_V2      = mkV2 (mkV "beber") ;
   eat_V2        = mkV2 (mkV "comer") ;
   fear_V2       = mkV2 (mkV "temer") ;
   fight_V2      = mkV2 (mkV "lutar") ;
   find_V2       = mkV2 (mkV "encontrar") ;
   forget_V2     = mkV2 (mkV "esquecer") ;
   ...
   open_V2       = mkV2 (special_ppV (mkV "abrir") "aberto") ;
   play_V2       = mkV2 (mkV "jogar") ;
   pull_V2       = mkV2 (mkV "tirar") ;
   push_V2       = mkV2 (mkV "empurrar") ;
   put_V2        = mkV2 (mkV (pôr_Besch "pôr")) ;
   read_V2       = mkV2 (mkV (ler_Besch "ler")) ;
   rub_V2        = mkV2 (mkV "esfregar") ;
   scratch_V2    = mkV2 (mkV "coçar") ;
   see_V2        = mkV2 (mkV (ver_Besch "ver")) ;
   seek_V2       = mkV2 (mkV "buscar") ;
   speak_V2      = mkV2 (mkV "falar") ;
   split_V2      = mkV2 (mkV "separar") ; -- dividir,) ;
   ...
   tie_V2        = mkV2 (mkV "atar") ;
   understand_V2 = mkV2 (mkV "entender") ;
   wait_V2       = mkV2 (mkV "esperar") dative ;
   wash_V2       = mkV2 (mkV "lavar") ;
   watch_V2      = mkV2 (mkV "ver") ;		-- ver
   win_V2        = mkV2 (mkV "ganhar") ;
   wipe_V2       = mkV2 (mkV "remover") ;
   write_V2      = mkV2 (special_ppV (mkV "escrever") "escrito") ;
   add_V3 = mkV3 (mkV "somar") dative ;
   give_V3 = mkV3 (mkV (dar_Besch "dar")) ;
