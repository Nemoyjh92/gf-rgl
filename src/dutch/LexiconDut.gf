...
cat_N = mkN "kat" utrum ;
ceiling_N = mkN "plafond" "plafonds" neuter ;
...
cow_N = mkN "koe" "koeien" utrum ;
cut_V2 = mkV2 snijden_V ;
day_N = mkN "dag" "dagen" utrum ;
dig_V = graven_V ;
dirty_A = mkA "vuil" ;
do_V2 = mkV2 doen_V ;
...
earth_N = mkN "aard" utrum ;
egg_N = mkN "ei" "eieren" neuter ;
empty_A = mkA "leeg" ;
...
horn_N = mkN "hoorn" "hoorns" utrum ;
horse_N = mkN "paard" neuter ;
hot_A = mkA "heet" ;
hunt_V2 = mkV2 jagen_V ;
...
lie_V = liggen_V ;
like_V2 = mkV2 (partV vinden_V "leuk") ;
...
ship_N = mkN "schip" "schepen" neuter ;
...
walk_V = lopen_V ;
war_N = mkN "oorlog" "oorlogen" utrum ;
