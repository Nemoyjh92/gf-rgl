...
concrete IrregSwe of IrregSweAbs = CatSwe ** open ParadigmsSwe in {
  ...
  draga_V = mkV "dra" "drar" "dra" "drog" "dragit" "dragen" | mkV "draga" "drog" "dragit" ;
  ...
  veta_V = mk6V "veta" "vet" "vet" "visste" "vetat" "visst" ;
  vända_V = irregV "vända" "vände" "vänt" ;
  vilja_V = mkV "vilja" "vill" "vilj" "ville" "velat" "velad" ;
